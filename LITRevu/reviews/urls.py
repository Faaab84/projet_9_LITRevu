...
"""Configuration des URLs pour l'application de gestion des billets et commentaires."""
...
urlpatterns = [
    ...
    path(
        'commentaire/create/<int:billet_id>/',
        views.create_commentaire,
        name='commentaire-create'
    ),
    path(
        'commentaire/edit/<int:commentaire_id>/',
        views.edit_commentaire,
        name='edit-commentaire'
    ),
    path(
        'commentaire/delete/<int:commentaire_id>/',
        views.delete_commentaire,
        name='delete-commentaire'
    ),
    path(
        'billet-and-commentaire/create/',
        views.create_billet_and_commentaire,
        name='billet-and-commentaire-create'
    ),
]
